...
summary: Microsoft Entra 애플리케이션을 설정한 후 NetApp Console 에서 Azure NetApp Files 시스템을 만들어 필요한 볼륨을 만들 수 있습니다. 
---
= NetApp Console 에서 Azure NetApp Files 시스템 만들기
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Microsoft Entra 애플리케이션을 설정하고 NetApp Console 에 자격 증명을 추가한 후 Azure NetApp Files 시스템을 만들어 필요한 볼륨을 만들 수 있습니다.
